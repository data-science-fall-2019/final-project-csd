...
```{r}
write.csv(four_year_institution, file = "four_year_institution.csv", row.names = F)
```

```{r}
write.csv(four_year_data, file = "four_year_data.csv", row.names = F)
```

```{r}
write.csv(whole_income, file = "whole_income.csv", row.names = F)
```

```{r}
write.csv(case, file = "extreme_case.csv", row.names = F)
```

```{r}
write.csv(salary_tuition, file = "salary_tuition.csv", row.names = F)
```
...
ui <- fluidPage(
  ...
  column(12, dataTableOutput("ttest", width = "200px", height = "10px")), 
  column(11, dataTableOutput("table", width = "200px", height = "10px")), 
  )
